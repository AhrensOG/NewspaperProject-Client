    ...
    <div  className="bg-slate-50 w-full flex flex-row-reverse" >
      <div className="basis-[65%]">
        ...
        <Link href={`/detalle/${id}?tag=${tag}`}>
          <h3 className="font-custom font-semibold hover:underline underline-offset-1 cursor-pointer lg:text-[1.05rem] lg:leading-5 md:text-base md:leading-4 break-all" >{title}</h3>
        </Link>
      </div>
